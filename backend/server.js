...
app.post("/earnings/manual-balance", async (req, res) => {
    try {
        const earningsRes = await fetch(`${EARNINGS_SERVICE}/earnings/manual-balance`, {
            method: "POST",
        ...
        console.error("Manual balance proxy error:", err);
